        ...
        self._nav_rail = ft.NavigationRail(
            ...
            leading=ft.Container(
                content=ft.Column(
                    controls=[
                        ft.Container(
                            content=ft.Icon(
                                ft.Icons.GRID_VIEW_ROUNDED, color=t.SURFACE, size=24
                            ),
                            bgcolor=t.PRIMARY,
                            border_radius=10,
                            padding=10,
            ...
            destinations=[
                ft.NavigationRailDestination(
                    # Use 'icon' for the unselected state
                    icon=ft.Icon(item["icon"], size=22),
                    # Use 'selected_icon' (NOT selected_icon_content) for the active state
                    selected_icon=ft.Icon(item["icon"], size=22, color=t.PRIMARY),
                    label=item["label"],
                )
