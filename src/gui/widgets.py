...
def file_picker_field(
    ...
    return ft.Container(
        content=ft.Column(
            controls=[
                ft.Text(label, size=t.CAPTION_SIZE, weight=ft.FontWeight.W_600, color=t.TEXT_SECONDARY),
                ft.Container(
                    content=ft.Row(
                        controls=[
                            ft.Icon(ft.Icons.DESCRIPTION_OUTLINED, size=18, color=t.TEXT_SECONDARY),
                            ft.Text(
    ...
    return ft.Container(
        content=ft.Row(
            controls=[
                ...
                ft.Text(text, size=t.CAPTION_SIZE, color=color, weight=ft.FontWeight.W_600),
            ],
            spacing=4,
            tight=True,
        ),
